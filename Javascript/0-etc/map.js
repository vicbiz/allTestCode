...
var initMap = {
    ...
    drawMap : function(destinations){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(isCollectionUrl){
                        ...
                        collectionTitle = "<h2><a href='"+data.collection.uri+"'>"+data.collection.name+"</a></h2>";
                    }
                    ...
                    if(mapData.length > 0){
                        ...
                        if(!initFilterType){ initFilterType = "hotels"; }
                        var initSort = ftgUtil.getUrlParameter("initSort");
        ...
        initMarkers = markers;
        console.log("initMarkers",initMarkers);
