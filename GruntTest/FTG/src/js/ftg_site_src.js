...
$(function(){
    ...
    $(document).ready(function() {
        ...
        // Todo: BLOG needs to update when LIVE *******************************************
        var isBlog = false;
        var globalImageBase = "";
        ...
        if($("#ftgNavWrap").length > 0){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $(".newsLetterLegal").html(data.footerInclude.signUpText);
                    ...
                    $("#ftgFooter .footerLegal").html(data.footerInclude.legalText);
        ...
        */
        ...
        var ftg = {
                ...
                $('.signUpNewsLetter').validator().on('submit', function (e) {
                    ...
                    if (e.isDefaultPrevented()) {
                        ...
                        if(agreed){
                            ...
                            $targetWrap.find(".signUpNewsLetterInput").html("<span>Sending Data .....</span>");
                            $errMsgWrap.addClass("hidden");
                            // console.log("in popup? : "+$targetWrap.hasClass("popupNewsLetter"));
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            isMobile : function(){
                return $("#topMobileButton").is(":visible");
            },
...
*/
            ...
            destinationListPage : function(){
                $("#destinationListBlock .listBlockPage").each(function(){
                    var $this = $(this);
                    var liCount = $(this).find("li").length;
                    // if(liCount < 30){
                    //     var emptyList = '<ul>';
                    //     for(var i=0; i<100-liCount; i++){
                    //         emptyList += '<li class="emptyList">&nbsp;</li>';
                    //     }
                    //     emptyList += '</ul>';
                ...
                $("#destinationListFilterBlock .regionFilter, #destinationListBlock .showDrillDown").on("click", function(){
                    ...
                    // }
                    // if($(".filterByButtons").is(":visible")){
                    //     $("html, body").animate({ scrollTop: $('#destinationListFilterBlock').offset().top +60}, 500);
                    // }
                ...
                if($(".filterByButtons").length > 0){
                    $(".filterByMenu li").on("click", function(){
                        ...
                        // $(".filterByMenu").hide();
                        // $('html, body').animate({
                        //     // scrollTop: $("#destinationListFilterBlock .filterByWrap").offset().top
                        //     scrollTop: 135
                        // }, 100);
            ...
            destinationPropertiesPage : function(){
                if($(document).find(".filter-container .propBox").length >0){
                    ...
                    $("#viewMapDestination").on("click", function(e){
                        e.preventDefault();
                        var newUrl = $(this).attr("href") + '&initFilterType=' + $("#filterButtonWrap a.active").attr("data-type");
                        window.location.href = newUrl;
                    });
                }
                ...
                if(initTypeShow && initTypeShow !== 'hotels'){
                ...
                // console.log("destinationName:"+destinationName+" destinationPropType:",destinationPropType," destinationSort:",destinationSort);
                ...
                var initMap = {
                    ...
                    drawMap : function(destinations){
                        ...
                        google.maps.event.addListener(markerClusterer, 'clusterclick', function(cluster) {
                            ...
                            // cluster.markerClusterer.clusters_.markers
                            // console.log(cluster);
                            // console.log(cluster.markerClusterer_.clusters_.length);
                            // console.log(cluster.center_.lat()+" : "+cluster.center_.lng());

                            // var mainClusterGeo = cluster.center_.lat()+" : "+cluster.center_.lng();
                            // $.each(cluster.markerClusterer_.clusters_, function (i, subCluster) {
                            //     var subClusterGeo = subCluster.center_.lat()+" : "+subCluster.center_.lng();
                            //     if(mainClusterGeo === subClusterGeo){
                            //         console.log("found : "+i);
                            //     }
                            // });
                    ...
                    // mapControl : function(controlDiv, map, defaultZoom, mapCenter, markers, initMarkers, markerCluster, propMarkers) {
                    //     console.log("propMarkers");
                    //     console.log(propMarkers);
                    // },
                };
            ...
            collectionDetailPage : function(){
                if($(document).find(".filter-container .propBox").length >0){
                    ...
                    $('.filter-buttons a:active').trigger("click");
                    ftgUtil.updateEmptyFilter();
                ...
                // console.log("collectionPropType",collectionPropType," collectionDestination ",collectionDestination);
