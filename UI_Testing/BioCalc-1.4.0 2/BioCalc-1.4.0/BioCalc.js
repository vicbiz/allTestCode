...
(function($) {
  lu.bioCalc.mainPage.pageSections.BirthdaySectionView = function(presenter) {
    ...
    function initialize$() {
      $birthdayTextBox.datepicker({yearRange: "-100:+0",
changeMonth:true, changeYear:true, dateFormat:"yy-mm-dd", onSelect:onBirthdayDatePickerSelect, showButtonPanel:true});
...
(function($) {
  lu.bioCalc.mainPage.pageSections.ChartsSectionView = function() {
    ...
    function initialize$() {
      $firstDayTextBox.datepicker({yearRange: "-100:+0",
changeMonth:true, changeYear:true, dateFormat:"yy-mm-dd", showButtonPanel:true, showAnim:""});
      $lastDayTextBox.datepicker({yearRange: "-100:+0",
changeMonth:true, changeYear:true, dateFormat:"yy-mm-dd", showButtonPanel:true, showAnim:""});
